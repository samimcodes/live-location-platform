  ...
  return (
    <div className="h-screen max-h-screen w-full flex overflow-hidden bg-white dark:bg-[#070B16] text-slate-900 dark:text-foreground">
      ...
      {/* ══════════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════════ */}
      <AuthLeftHero
        badgeText="JOIN 2,400+ FAMILIES"
        title="Start protecting"
        gradientTitle="your family circle today."
        subtitle="Create your free family circle in less than 60 seconds. Real-time GPS mesh, sub-20ms latency, and zero battery drain."
      />

      {/* ══════════════════════════════════════════════════════
          RIGHT PANEL — Clean, Theme-Aware Signup Form Panel
          ══════════════════════════════════════════════════════ */}
      <div className="flex-1 h-full max-h-screen flex flex-col bg-slate-50 dark:bg-[#070B16] relative transition-colors duration-300 overflow-y-auto lg:overflow-hidden justify-between py-3.5 sm:py-5 px-4 sm:px-8">
        ...
        <div className="flex-1 flex items-center justify-center py-1">
          <motion.div
            ...
            className="w-full max-w-[420px] bg-white dark:bg-[#0E1528] rounded-3xl shadow-xl dark:shadow-[0_20px_50px_rgba(0,0,0,0.6)] border border-slate-200/80 dark:border-slate-800 p-5 sm:p-6"
          >
            {/* Card heading */}
            <div className="flex flex-col items-center text-center mb-3">
              <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-violet-600 via-indigo-600 to-cyan-600 flex items-center justify-center text-white shadow-md shadow-violet-500/25 mb-2">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 font-medium">
                Join LocaLink to start sharing live locations safely
              </p>
            </div>
